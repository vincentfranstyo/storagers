            ...
            <div class="mt-16 min-w-fit">
                <div
                    ...
                    <div class="flex flex-col pt-10">
                        ...
                        {{--                        </div>--}}
                        <div
                            class="flex text-3xl pl-1 pt-2 justify-content-center items-center text-gray-500 dark:text-white">
                            box
                        </div>
                    </div>
                    <div
                        class="flex items-center h-auto text-gray-500 dark:text-white text-xl pb-5 pr-5 pt-5 w-40">
                        <div class="flex flex-col-reverse gap-1 items-end h-auto text-gray-500 dark:text-white text-lg pb-1 pr-5 pt-1 min-w-fit">
                            <div>total:</div>
                            <div><label for="amount">amount:</label></div>
                            <div>stock:</div>
                        </div>
                        <div class="flex flex-col-reverse gap-1 h-auto text-gray-500 dark:text-white text-lg pb-1 pr-5 pt-1 min-w-fit">
                            <div>$30</div>
                            <div><input type="number" name="amount" id="amount" class="w-20 h-8 dark:text-white bg-blue-950"></div>
                            <div>x pieces</div>
                        </div>
